...
The operator **Idx** *(indexing)* is defined by `A Idx B = A_B`. Apart from **Idx** and **Inv**, the other operators are those of elementary arithmetic and retain their semantics of elementary arithmetic.
